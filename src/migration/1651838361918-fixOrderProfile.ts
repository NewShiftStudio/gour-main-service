...
export class fixOrderProfile1651838361918 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "order_profile" DROP COLUMN "firstName"`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_profile" DROP COLUMN "lastName"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "order" ADD "firstName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "lastName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "phone" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "email" character varying NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order_profile" ADD "email" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_profile" ADD "phone" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_profile" ADD "lastName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_profile" ADD "firstName" character varying NOT NULL`,
    );
  }
}
