...
export class updateClient1650009739415 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_802c14334992c11bd47014cdff"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "client" ADD "referralCode" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "client" ADD "password" character varying NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "client" ADD "apiUserUuid" uuid NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_802c14334992c11bd47014cdff" ON "client" ("apiUserUuid") `,
    );
  }
}
