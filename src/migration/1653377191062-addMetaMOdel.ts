...
export class addMetaMOdel1653377191062 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."meta_type_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`ALTER TABLE "meta" ADD "type" "public"."meta_type_enum" NOT NULL`);
    }
