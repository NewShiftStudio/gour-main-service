...
export class addReferralCode1650468064995 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "client" RENAME COLUMN "referralCode" TO "referralCodeId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "client" DROP COLUMN "referralCodeId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "client" ADD "referralCodeId" integer`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "client" ADD "referralCodeId" character varying`,
    );
    await queryRunner.query(`DROP TABLE "referral_code"`);
    await queryRunner.query(
      `ALTER TABLE "client" RENAME COLUMN "referralCodeId" TO "referralCode"`,
    );
  }
}
